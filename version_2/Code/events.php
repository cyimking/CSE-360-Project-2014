...
if(isset($_POST['submit']))
{
	...
	switch($action){
		case "Create Event":
			...
			$ticket_name = sanitize($_POST['ticket_name']);
			$max_tickets = sanitize($_POST['max_tickets'],"int");
			$max_tickets_pp = sanitize($_POST['max_tickets_purchase'],"int");
			check_add_event($title,$type,$venue,$description,$date,$start_time,$end_time,$ticket_name,$max_tickets,$max_tickets_pp);
			break;
