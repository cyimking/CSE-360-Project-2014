...
if(isset($_POST['submit']))
{
	...
	switch($action){
		case "Create Account": 
			...
			$email  = sanitize($_POST['email_reg'],"email");
...
function display_registration_table()
{
	...
	echo '
		...
		<input type="email" size="70%"  placeholder="Email" class="register_input" id="email" name="email_reg" 
		style="position:relative; margin-left: 10px" required="required">
...
function display_login_table()
{
	...
	echo'	
		...
		<input type="submit" value="Sign In" name="submit" id="sign_in_submit">
		</form>
		</div>
